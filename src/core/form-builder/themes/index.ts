...
const themes: Theme[] = [
  ...
  },
  {
    ...
    formField: "mb-6",
    label: "block text-gray-400 text-lg font-semibold mb-2",
    text: "bg-gray-800 appearance-none border-2 border-gray-700 rounded w-full py-3 px-4 text-gray-400 leading-tight focus:outline-none focus:bg-gray-700 focus:border-purple-500",
    email:
    ...
    reset:
      "bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg focus:outline-none focus:shadow-outline-red",
  },
  {
    name: "material",
    ...
    text: "appearance-none border border-gray-300 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent",
    email:
    ...
    reset:
      "bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2",
  },
  {
    name: "minimal",
    ...
    formField: "mb-4",
    label: "block text-gray-700 text-sm font-bold mb-2",
    text: "appearance-none border-b-2 border-gray-300 w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-blue-500",
    email:
    ...
    reset:
      "text-red-500 hover:text-red-700 font-semibold py-2 px-4 focus:outline-none",
  },
];
