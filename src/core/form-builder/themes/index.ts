...
const themes: Theme[] = [
  {
    name: "light",
    form: "bg-white shadow-md rounded px-6 py-6 mb-6",
    formField: "mb-4",
  ...
  {
    name: "dark",
    form: "bg-gray-900 shadow-md rounded px-6 py-6 mb-6",
    formField: "mb-4",
    label: "block text-gray-100 text-sm font-bold mb-2",
    input:
      "bg-gray-800 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-gray-400 leading-tight focus:outline-none focus:bg-gray-700 focus:border-primary-500",
    email:
      "bg-gray-800 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-gray-400 leading-tight focus:outline-none focus:bg-gray-700 focus:border-primary-500",
    select:
      "bg-gray-800 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-gray-400 leading-tight focus:outline-none focus:bg-gray-700 focus:border-primary-500",
    checkbox: "form-checkbox h-5 w-5 text-primary-500",
    radio: "form-radio h-5 w-5 text-primary-500",
    textarea:
      "bg-gray-800 appearance-none border border-gray-700 rounded w-full py-2 px-3 text-gray-400 leading-tight focus:outline-none focus:bg-gray-700 focus:border-primary-500",
    error: "text-red-400 text-xs italic mt-2",
    button:
      "bg-primary-600 hover:bg-primary-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-primary",
    submit:
      "bg-primary hover:bg-primary/80 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-green",
  },
  {
    name: "material",
    form: "bg-gray-100 shadow-md rounded px-6 py-6 mb-6",
    formField: "mb-4",
