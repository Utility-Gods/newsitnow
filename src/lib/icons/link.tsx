export default function () {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M1.99609 10.001H15.3641C15.9911 10.001 16.2041 10.3682 16.6841 10.9442C17.2361 11.4842 17.6093 11.863 18.1241 11.9402C18.8441 12.0482 21.5081 11.9942 21.5081 11.9942"
        stroke="currentColor"
        stroke-width="1.5"
        stroke-linecap="round"
      />
