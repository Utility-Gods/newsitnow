  ...
  return (
    <div class="flex flex-col gap-4 px-3 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
      ...
      <p>
        ...
        and/or web beacons to track visitor activities on this website in order
        to display advertisements and other useful information. Such tracking is
        ...
        control over these cookies, scripts and/or web beacons that may be used
        by third parties. Learn how to{" "}
      ...
      <p>
        ...
        us an email to contact@utilitygods.com.
      </p>
    </div>
  );
}
