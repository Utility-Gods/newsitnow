    ...
    <div>
      <div class="flex flex-col gap-4 px-3 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <p>
          ...
          https://www.orangegas.co (the "Service"). Please read them carefully.
        </p>
        ...
        <p>
          ...
          please let us know by e-mailing [SUPPORT EMAIL ADDRESS].
        </p>
        ...
        <p>
          ...
          [TIME PERIOD] after we post such revised Terms (indicated by revising
          the date at the top of these Terms) or upon your acceptance if we
          provide a mechanism for your immediate acceptance of the revised Terms
          (such as a click-through confirmation or acceptance button). It is
          your responsibility to check [APP NAME] for changes to these Terms.
        </p>
        ...
        <p>
          [CUSTOMIZE THE FOLLOWING SECTION BASED ON THE TYPE OF CONTENT
          SUBMITTED BY USERS.]
        </p>
        ...
        <p>
          ...
          [TIME PERIOD] and then delete them.
        </p>
